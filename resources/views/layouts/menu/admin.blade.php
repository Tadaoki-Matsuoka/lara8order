            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{route('admin.order.create')}}" class="nav-link">新規追加</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{route('admin.product.create')}}" class="nav-link">新規追加</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{route('admin.customer.create')}}" class="nav-link">新規追加</a></li>
                    </ul>
                </li>
            </ul>
            <ul class="navbar-nav mr-auto">
