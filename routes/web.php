...
Route::get('/admin/order/{id}/detail/create', [App\Http\Controllers\OrderDetailController::class, 'create'])->name('admin.detail.create');
Route::post('/admin/order/{id}/detail', [App\Http\Controllers\OrderDetailController::class, 'store'])->name('admin.detail.store');
Route::get('/admin/order/{id}/detail/edit', [App\Http\Controllers\OrderDetailController::class, 'edit'])->name('admin.detail.edit');
Route::put('/admin/order/detail/{id}', [App\Http\Controllers\OrderDetailController::class, 'update'])->name('admin.detail.update');